...
<p>Durch Klick auf die Überschrift <b>Wolkenkratzer</b> werden die Wolkenkratzerlevel und der <b>Skyline Tower</b> angezeigt. In der <b>einfachen Ansicht</b> wird nur der Gebäudezähler angezeigt. Der Panoramaeffekt kann hier nicht berücksichtigt werden. In der komplexen Ansicht enthält jede Zeile die Anzahl an Gebäuden, das Einwohnerlimit pro Haus (5) sowie das Gesamtlimit (3) des Levels. Die Einwohnerzahl pro Haus muss manuell anhand des <b>Panoramaeffekts</b>, Items und weiterer Effekte geschätzt werden. Abgesehen von der Wolkenkratzerverwaltung unter Finanzen bietet das Spiel hier keine Hilfe. Es empfiehlt sich, erst den pro-Haus-Wert anzupassen und danach die Gebäudeanzahl zu aktualisieren. So ist gewährleistet, dass das Bevölkerungslimit links korrekt aktualisiert wird. Vom Bevölkerungslimit hängt der Verbrauch ab, wie viele Einwohner dagegen aktuell in einem Wolkenkratzer leben ist unerheblich. Sobald ein Wolkenkratzer gebaut ist, fungieren die darüberstehenden Angaben als Zusammenfassung. So kann Einwohner (max.) pro Wohnhaus nicht mehr geändert werden und Einwohner pro Haus nicht mehr gesperrt. Damit sich die Eingabefelder aber ohne Wolkenkratzer wie bisher verhalten, war es nötig, reguläre Häuser mit aufzunehmen und deren Werte synchron zu halten. Änderungen in den oberen Eingabefeldern wirken sich folglich nur auf die Häuser aus und sollten vermieden werden.</p><br/>
